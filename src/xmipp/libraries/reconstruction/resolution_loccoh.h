...
class ProgLocCoh: public XmippProgram
{
 public:
    // Input params
    ...
    // Data variables
    MultidimArray<double> LocCohMap;       // Local Coherence
    MultidimArray<double> sum_map;      // Accumulate map components
    MultidimArray<double> sum_map2;     // Accumulate squared map components
